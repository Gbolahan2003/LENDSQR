    ...
    const handleLogin = () => {
        if (auth) {
          const userObj: User = {
            ...
            username: user, // Use the 'user' string as the username
          };
          auth.login(userObj);
          navigate('/home');
        } else {
          // Handle the case where auth is null (e.g., show an error message)
  ...
  return  (
    ...
    <div>
        <div className="login-container">
            <header>
                <div className="login-icon"><svg className='svg'  xmlns="http://www.w3.org/2000/svg" width="174" height="36" viewBox="0 0 174 36" fill="none">
  ...
  <defs>
    <linearGradient id="paint0_linear_6819_58335" x1="-1.87183e-06" y1="38.9211" x2="26.2531" y2="-4.22382" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="1" stop-color="#39CDCC"/>
            ...
            <form className="login" action='submit'  >
                <h1>welcome!</h1>
                <h3 className="details">
                    Enter details to login
                </h3>
                <div className="inputs">
                    <input type="email" placeholder='Email' onChange={e => setUser(e.target.value)} required/>
